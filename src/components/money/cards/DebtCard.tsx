    ...
    <div style={{ minHeight: 360 }}>
      ...
      <div className="rounded-[20px] p-5 mb-3" style={{ background: "#f3f3f8" }}>
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[10px] font-bold rounded-full px-2 py-0.5" style={{ background: "rgba(70,72,212,0.1)", color: "#4648d4" }}>97% Remaining</span>
        </div>
        <p className="text-xs mb-2" style={{ color: "#767586" }}>4.5% APR · Remaining: $67,400 · Est. payoff: 74 months</p>
        <div className="h-2 rounded-full" style={{ background: "#e8e8ed" }}><div className="h-full rounded-full" style={{ width: "3%", background: "#4648d4" }} /></div>
      </div>
      ...
      {/* Insight */}
      <div className="rounded-[20px] p-4" style={{ background: "rgba(70,72,212,0.05)", border: "1px solid rgba(70,72,212,0.1)" }}>
        <p className="text-xs leading-relaxed" style={{ color: "#464554" }}>
          <span className="font-bold" style={{ color: "#4648d4" }}>✦</span> Pay $100 extra/month on student loans → Save $12,400 in interest and be debt-free 1.2 years early.
        </p>
      </div>
    </div>
  );
